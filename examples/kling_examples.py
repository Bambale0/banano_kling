...
async def example_multishot():
    ...
    multi_prompt = [
        {
            "prompt": "A car driving through a forest road",
            "duration": "3"
        },
        {
            "prompt": "The car arrives at a futuristic city",
            "duration": "4"
        },
        {
            "prompt": "The car parks in front of a tall building",
            "duration": "3"
        }
    ]
...
async def example_list_tasks():
    ...
    tasks = await kling_service.list_v3_tasks(
        page=1,
        page_size=20
    )

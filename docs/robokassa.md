...
Сейчас в пользовательском UX основной RUB checkout — Lava. Ниже идёт KASSA, затем Robokassa как резервный способ до завершения подключения нужных методов оплаты в кабинете.

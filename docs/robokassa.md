# Robokassa — резервный RUB checkout

Сейчас в пользовательском UX основной RUB checkout — Lava. Robokassa временно показывается ниже как резервный способ до завершения подключения нужных методов оплаты в кабинете.

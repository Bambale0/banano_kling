...
def _soft_runtime_prompt(
    ...
    *,
    ...
    return (
        ...
        "Reference guidance:\n"
        "- Image 1 is the Pinterest scene reference. Use its visual setup: pose, "
        "composition, camera, clothing, lighting, background and mood. Natural "
        "adjustments are allowed when needed for the user's anatomy and likeness.\n"
        "- Image 2 is the user's identity reference. Keep that person clearly "
        "recognizable, including their own face, apparent age, skin tone, hair "
        "color/length and natural build.\n"
        "- Additional user photos, when present, are only extra likeness evidence.\n"
...
def _soft_provider_payload(
    ...
    provider_prompt = (
        ...
        "- Image 1 is the user's identity reference. Keep this person recognizable "
        "and use their own facial features, age impression, skin tone, hair "
        "color/length and natural build.\n"
        "- Image 2 is the Pinterest scene reference. Use its pose, composition, "
        "camera, clothing, lighting, background and overall photographic mood.\n"
...
def _soft_legacy_provider_prompt(*, measurements: str = "not provided") -> str:
    ...
    return (
        ...
        f"{PINTEREST_REFERENCE_GUIDANCE_MARKER}\n"
        "Reference guidance:\n"
        "- Image 1 is the user's identity reference; keep that person recognizable.\n"
        "- Image 2 is the Pinterest scene reference; use it for pose, composition, "
        "camera, clothing, lighting and background.\n"

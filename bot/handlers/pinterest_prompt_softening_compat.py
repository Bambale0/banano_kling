...
def _soft_runtime_prompt(
    ...
    *,
    ...
    return (
        ...
        "age, skin tone, hair color/length and natural build. If scene styling and "
        "identity conflict, identity from USER_IDENTITY_REFERENCE always wins.\n"
...
def _soft_provider_payload(
    ...
    provider_prompt = (
        ...
        "impression, skin tone, hair color/length and natural build. If scene styling "
        "and identity conflict, identity from USER_IDENTITY_REFERENCE always wins.\n"

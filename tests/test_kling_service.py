...
class TestKlingServiceInit:
    ...
    def test_endpoints_config(self):
        ...
        # Kling 3 Omni R2V
        assert KlingService.ENDPOINTS["v3_omni_pro_r2v"] == "/v1/ai/reference-to-video/kling-v3-omni-pro"
        assert KlingService.ENDPOINTS["v3_omni_std_r2v"] == "/v1/ai/reference-to-video/kling-v3-omni-std"
        assert KlingService.ENDPOINTS["v3_omni_r2v_tasks"] == "/v1/ai/reference-to-video/kling-v3-omni"
...
class TestBuildV3Payload:
    ...
    def test_cfg_scale_clamping(self):
        ...
        payload = service._build_v3_payload(
            ...
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=2.0,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
        )
        ...
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=-1.0,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
        )
    ...
    def test_duration_clamping(self):
        ...
        # Верхняя граница
        payload = service._build_v3_payload(
            prompt="test", duration=20, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=0.5,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
        )
        ...
        # Нижняя граница
        payload = service._build_v3_payload(
            prompt="test", duration=1, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=0.5,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
    ...
    def test_aspect_ratio_validation(self):
        ...
        # Невалидный формат
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="21:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=0.5,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
    ...
    def test_image_list_first_frame(self):
        ...
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url="https://example.com/start.jpg",
            end_image_url=None, elements=None, negative_prompt=None,
            cfg_scale=0.5, generate_audio=True, voice_ids=None,
            multi_prompt=None, shot_type="customize", multi_shot=False,
        )
    ...
    def test_image_list_end_frame(self):
        ...
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None,
            end_image_url="https://example.com/end.jpg", elements=None,
            negative_prompt=None, cfg_scale=0.5, generate_audio=True,
            voice_ids=None, multi_prompt=None, shot_type="customize",
            multi_shot=False,
        )
    ...
    def test_webhook_url(self):
        ...
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url="https://example.com/webhook", start_image_url=None,
            end_image_url=None, elements=None, negative_prompt=None,
            cfg_scale=0.5, generate_audio=True, voice_ids=None,
            multi_prompt=None, shot_type="customize", multi_shot=False,
        )
    ...
    def test_elements(self):
        ...
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=elements, negative_prompt=None, cfg_scale=0.5,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
        )
    ...
    def test_negative_prompt(self):
        ...
        payload = service._build_v3_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt="blurry, distorted", cfg_scale=0.5,
            generate_audio=True, voice_ids=None, multi_prompt=None,
            shot_type="customize", multi_shot=False,
        )
    ...
    def test_voice_ids(self):
        ...
        payload = service._build_v3_payload(
            ...
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=0.5,
            generate_audio=True, voice_ids=["voice_1", "voice_2", "voice_3"],
            multi_prompt=None, shot_type="customize", multi_shot=False,
        )
    ...
    def test_multi_prompt(self):
        ...
        payload = service._build_v3_payload(
            ...
            webhook_url=None, start_image_url=None, end_image_url=None,
            elements=None, negative_prompt=None, cfg_scale=0.5,
            generate_audio=True, voice_ids=None, multi_prompt=multi_prompt,
            shot_type="customize", multi_shot=False,
        )
...
class TestBuildOmniPayload:
    ...
    def test_omni_aspect_ratio_auto(self):
        ...
        payload = service._build_omni_payload(
            prompt="test", duration=5, aspect_ratio="auto",
            webhook_url=None, start_image_url=None, end_image_url=None,
            image_url=None, image_urls=None, elements=None,
            generate_audio=True, voice_ids=None, multi_prompt=None,
        )
    ...
    def test_omni_image_list(self):
        ...
        payload = service._build_omni_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url="https://example.com/start.jpg",
            end_image_url=None, image_url=None, image_urls=None,
            elements=None, generate_audio=True, voice_ids=None,
            multi_prompt=None,
        )
    ...
    def test_omni_image_urls(self):
        ...
        payload = service._build_omni_payload(
            prompt="test", duration=5, aspect_ratio="16:9",
            webhook_url=None, start_image_url=None, end_image_url=None,
            image_url=None, image_urls=image_urls, elements=None,
            generate_audio=True, voice_ids=None, multi_prompt=None,
        )
...
class TestKlingServiceMethods:
    ...
    async def test_text_to_video(self):
        ...
        with patch.object(service, 'generate_video_std', new_callable=AsyncMock) as mock_gen:
    ...
    async def test_image_to_video(self):
        ...
        with patch.object(service, 'generate_video_omni_std', new_callable=AsyncMock) as mock_gen:
    ...
    async def test_video_to_video(self):
        ...
        with patch.object(service, 'generate_video_omni_std_r2v', new_callable=AsyncMock) as mock_gen:
    ...
    async def test_get_task_status(self):
        ...
        with patch.object(service, '_get_request', new_callable=AsyncMock) as mock_get:
            ...
            assert result["data"]["result"]["video_url"] == "https://example.com/result.mp4"
...
class TestModelMapping:
    ...
    async def test_generate_video_model_mapping(self):
        ...
        # Тест v3_pro
        with patch.object(service, 'generate_video_pro', new_callable=AsyncMock) as mock_pro:
            await service.generate_video(prompt="test", model="v3_pro")
            mock_pro.assert_called_once()
        
        # Тест v3_std
        with patch.object(service, 'generate_video_std', new_callable=AsyncMock) as mock_std:
            await service.generate_video(prompt="test", model="v3_std")
            mock_std.assert_called_once()
        
        # Тест v3_omni_pro
        with patch.object(service, 'generate_video_omni_pro', new_callable=AsyncMock) as mock_omni:
            await service.generate_video(prompt="test", model="v3_omni_pro")
            mock_omni.assert_called_once()
        
        # Тест v3_omni_std
        with patch.object(service, 'generate_video_omni_std', new_callable=AsyncMock) as mock_omni_std:

...
class TestGenerateImage:
    ...
    async def test_generate_image_text_to_image(self):
        ...
        service = GeminiService(
            api_key="test_key", nanobanana_key="test_nanobanana", openrouter_key=""
        )

        # Мокаем _generate_via_nanobanana
        with patch.object(
            service, "_generate_via_nanobanana", new_callable=AsyncMock
        ) as mock_nb:
            ...
            result = await service.generate_image(
                prompt="A beautiful sunset", model="gemini-2.5-flash-image"
            )
    ...
    async def test_generate_image_fallback_to_openrouter(self):
        ...
        with patch.object(
            ...
            with patch.object(
                service, "_generate_via_openrouter", new_callable=AsyncMock
            ) as mock_or:
...
class TestNanoBananaGeneration:
    ...
    async def test_nanobanana_payload_basic(self):
        ...
        mock_response = {
            "choices": [
                {"message": {"content": "data:image/png;base64,SGVsbG9Xb3JsZA=="}}
            ]
        }
        ...
        with patch.object(
            ...
            result = await service._generate_via_nanobanana(
                prompt="test prompt", model="gemini-2.5-flash-image"
            )
    ...
    async def test_nanobanana_with_aspect_ratio(self):
        ...
        with patch.object(
            ...
            result = await service._generate_via_nanobanana(
                prompt="test", aspect_ratio="16:9", resolution="2K"
            )
    ...
    async def test_nanobanana_with_search(self):
        ...
        with patch.object(
            ...
            result = await service._generate_via_nanobanana(
                prompt="test", enable_search=True
            )
...
class TestOpenRouterGeneration:
    ...
    async def test_openrouter_response_parsing(self):
        ...
        service = GeminiService(
            api_key="test_key", nanobanana_key="", openrouter_key="test_openrouter"
        )
        ...
        with patch.object(
            ...
            mock_resp.text = AsyncMock(
                return_value='{"choices": [{"message": {"images": ["data:image/png;base64,'
                + b64_image
                + '"], "content": ""}}]}'
            )
            mock_session_instance.post = AsyncMock(return_value=mock_resp)
            ...
            result = await service._generate_via_openrouter(
                prompt="test prompt", model="google/gemini-2.5-flash-image"
            )
...
class TestImageEditing:
    ...
    async def test_edit_image(self):
        ...
        with patch.object(
            service, "generate_image", new_callable=AsyncMock
        ) as mock_gen:
            mock_gen.return_value = b"edited_image"

            result = await service.edit_image(
                image_bytes=test_image, instruction="Add a red hat"
            )
    ...
    async def test_add_element(self):
        ...
        with patch.object(service, "edit_image", new_callable=AsyncMock) as mock_edit:
            ...
            result = await service.add_element(
                image_bytes=b"image", element="a red balloon"
            )
    ...
    async def test_remove_element(self):
        ...
        with patch.object(service, "edit_image", new_callable=AsyncMock) as mock_edit:
            ...
            result = await service.remove_element(
                image_bytes=b"image", element="the person"
            )
    ...
    async def test_style_transfer(self):
        ...
        with patch.object(service, "edit_image", new_callable=AsyncMock) as mock_edit:
            ...
            result = await service.style_transfer(
                image_bytes=b"image", style="impressionist"
            )
    ...
    async def test_replace_element(self):
        ...
        with patch.object(service, "edit_image", new_callable=AsyncMock) as mock_edit:
            ...
            result = await service.replace_element(
                image_bytes=b"image", old_element="the sky", new_element="a sunset"
            )
...
class TestReferenceImages:
    ...
    async def test_reference_limit_6_objects(self):
        ...
        with patch.object(
            ...
            result = await service.generate_with_references(
                prompt="test", reference_images=ref_images
            )
    ...
    async def test_reference_limit_5_persons(self):
        ...
        with patch.object(
            ...
            result = await service.generate_with_references(
                prompt="test", person_references=person_refs
            )
...
class TestHighResolution:
    ...
    async def test_generate_high_res_2k(self):
        ...
        with patch.object(
            ...
            result = await service.generate_high_res(prompt="Test", resolution="2K")
...
class TestGenerationStyles:
    ...
    async def test_generate_photorealistic(self):
        ...
        with patch.object(
            ...
            result = await service.generate_photorealistic(prompt="a cat")
            ...
            assert (
                "photorealistic" in prompt_arg.lower() or "camera" in prompt_arg.lower()
            )
    ...
    async def test_generate_sticker(self):
        ...
        with patch.object(
            ...
            result = await service.generate_sticker(prompt="a star")

            call_args = mock_gen.call_args
            prompt_arg = str(call_args)
            assert (
                "sticker" in prompt_arg.lower() or "transparent" in prompt_arg.lower()
            )
    ...
    async def test_generate_comic(self):
        ...
        with patch.object(
            ...
            result = await service.generate_comic(prompt="a superhero flying")
    ...
    async def test_generate_minimalist(self):
        ...
        with patch.object(
            ...
            result = await service.generate_minimalist(
                subject="a flower", position="center"
            )
...
class TestMultiturnChat:
    ...
    async def test_send_message_to_chat(self):
        ...
        result = await service.send_message_to_chat(
            chat_id="test_chat", message="Make it brighter"
        )

...
for _name in (
    "ALLOW_NSFW", "COMETAPI_BASE_URL", "COMETAPI_KEY", "COMET_API_KEY",
    "CRYPTOBOT_API_TOKEN", "DATABASE_URL", "DEBUG",
    ...
    "QWEN38_PROMPT_MAX_ATTEMPTS", "QWEN38_PROMPT_MAX_TOKENS",
    "QWEN38_PROMPT_MODEL", "QWEN38_PROMPT_REASONING_EFFORT",
    "QWEN38_PROMPT_TIMEOUT_SECONDS", "QWEN38_VIDEO_FPS", "STATIC_BASE_URL",
    "TELEGRAM_STARS_FLAT_FEE", "TELEGRAM_STARS_PER_RUB",
